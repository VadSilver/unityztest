...
namespace CompleteProject
{
    public class EnemyHealth : MonoBehaviour
    {
        ...
        void Death ()
        {
            ...
            // pManageWave.pCount--;
            if (pManageWave) {
                pManageWave.CheckCount(gameObject.transform);
            }
        ...
        void DeathExplosiveLater()
        {
            GetComponent<NavMeshAgent>().speed = GetComponent<NavMeshAgent>().speed * 2;
            // The enemy is dead.
            isDeadExpl = true;
            hitParticles.loop = true;
            hitParticles.Play();
            Invoke("Explode", 3f);// Explode();
            Invoke("Death", 3f);// Death();
        }
